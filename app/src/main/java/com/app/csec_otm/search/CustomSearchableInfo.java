...
public class CustomSearchableInfo {
    ...
    static {
        ...
        // Other
        searchMaxLines = 1;
        isTwoLineExhibition = Boolean.TRUE;
    }
    ...
    public static void setIsTwoLineExhibition(Boolean isTwoLineExhibition) {
        com.app.csec_otm.search.CustomSearchableInfo.isTwoLineExhibition = isTwoLineExhibition;
    }
    ...
    public static void setBarHeight(Float barHeight) {
        com.app.csec_otm.search.CustomSearchableInfo.barHeight = barHeight;
    }
    ...
    public static void setResultItemHeight(Integer resultItemHeight) {
        com.app.csec_otm.search.CustomSearchableInfo.resultItemHeight = resultItemHeight;
    }
    ...
    public static void setResultItemHeaderTextSize(Integer resultItemHeaderTextSize) {
        com.app.csec_otm.search.CustomSearchableInfo.resultItemHeaderTextSize = resultItemHeaderTextSize;
    }
    ...
    public static void setResultItemSubheaderTextSize(Integer resultItemSubheaderTextSize) {
        com.app.csec_otm.search.CustomSearchableInfo.resultItemSubheaderTextSize = resultItemSubheaderTextSize;
    }
    ...
    public static void setSearchTextSize(Integer searchTextSize) {
        com.app.csec_otm.search.CustomSearchableInfo.searchTextSize = searchTextSize;
    }
    ...
    public static void setBarDismissIcon(Integer barDismissIcon) {
        com.app.csec_otm.search.CustomSearchableInfo.barDismissIcon = barDismissIcon;
    }
    ...
    public static void setBarMicIcon(Integer barMicIcon) {
        com.app.csec_otm.search.CustomSearchableInfo.barMicIcon = barMicIcon;
    }
    ...
    public static void setSimpleSuggestionsLeftIcon(Integer simpleSuggestionsLeftIcon) {
        com.app.csec_otm.search.CustomSearchableInfo.simpleSuggestionsLeftIcon = simpleSuggestionsLeftIcon;
    }
    ...
    public static void setSimpleSuggestionsRightIcon(Integer simpleSuggestionsRightIcon) {
        com.app.csec_otm.search.CustomSearchableInfo.simpleSuggestionsRightIcon = simpleSuggestionsRightIcon;
    }
    ...
    public static void setTransparencyColor(Integer transparencyColor) {
        com.app.csec_otm.search.CustomSearchableInfo.transparencyColor = transparencyColor;
    }
    ...
    public static void setPrimaryColor(Integer primaryColor) {
        com.app.csec_otm.search.CustomSearchableInfo.primaryColor = primaryColor;
    }
    ...
    public static void setTextPrimaryColor(Integer textPrimaryColor) {
        com.app.csec_otm.search.CustomSearchableInfo.textPrimaryColor = textPrimaryColor;
    }
    ...
    public static void setTextHintColor(Integer textHintColor) {
        com.app.csec_otm.search.CustomSearchableInfo.textHintColor = textHintColor;
    }
    ...
    public static void setRippleEffectMaskColor(Integer rippleEffectMaskColor) {
        com.app.csec_otm.search.CustomSearchableInfo.rippleEffectMaskColor = rippleEffectMaskColor;
    }
    ...
    public static void setRippleEffectWaveColor(Integer rippleEffectWaveColor) {
        com.app.csec_otm.search.CustomSearchableInfo.rippleEffectWaveColor = rippleEffectWaveColor;
    }
    ...
    public static void setSearchMaxLines(Integer searchMaxLines) {
        com.app.csec_otm.search.CustomSearchableInfo.searchMaxLines = searchMaxLines;
    }
}
